...
module.exports = class BotService{
    ...
    handler_message(msg, rinfo){
        ...
        switch(headers){
            ...
            case 0x7f00:
                ...
                return this.replace_name_map((Buffer.concat([before_name, name, after_name_before_map_name, map_name, after_map_name])), this.party.mapName, this.party.currentPlayers, this.party.maxPlayers)
    ...
    spawn(cords){
        ...
        //pj_response.writeUInt8(this.bot_number+1, 4)
        //this.arr_actions.push(pj_response)
        //console.log(`bot_${this.bot_number} spawn: `, cords)
        this.start = true
        ...
        this.bot_helper.send_event(JSON.stringify({type_action: 'spawn', value_action: cords, id_bot: this.bot_number}))
    }
